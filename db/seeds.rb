...
#USER
user = User.new
user.email = 'gizelle205@hotmail.com'
...
leon.artworks.create(art_title: "Still Life with Fruits & Wine", art_description: "Colorful fruit and wine", available: true, styles: [subjective, still_life], artmedia: [painting, canvass, oil_paint], user_id: user.id)
leon.artworks.create(art_title: "Glowing Crimson", art_description: "Colorful autumn trees", available: true, styles: [subjective, landscape], artmedia: [painting, canvass, oil_paint], user_id: user.id)
leon.artworks.create(art_title: "Sunset Embrace", art_description: "Colorful ocean waves", available: true, styles: [subjective, landscape], artmedia: [painting, canvass, oil_paint], user_id: user.id)
leon.artworks.create(art_title: "Voyages of Imagination", art_description: "Ship embarked on journey", available: true, styles: [subjective, landscape], artmedia: [painting, canvass, oil_paint], user_id: user.id)
...
gizelle.artworks.create(art_title: "Weathered Boat", art_description: "Black and white weathered boat", available: true, styles: [black_and_white], artmedia: [photography], user_id: user.id)
gizelle.artworks.create(art_title: "Wreckage", art_description: "Wrecked remains of a boat", available: true, styles: [black_and_white], artmedia: [photography], user_id: user.id)
...
toko.artworks.create(art_title: "Backlight", art_description: "Faded image capturing the light", available: true, styles: [figurative, portrait], artmedia: [digital], user_id: user.id)
toko.artworks.create(art_title: "Real Time", art_description: "After Jeremy Mann", available: true, styles: [figurative, portrait], artmedia: [digital], user_id: user.id)
toko.artworks.create(art_title: "WangjieLi", art_description: "After Wangjie Li", available: true, styles: [figurative, portrait], artmedia: [digital], user_id: user.id)
...
steve.artworks.create(art_title: "No. 1", art_description: "First in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "No. 2", art_description: "Second in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "No. 3", art_description: "Third in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "No. 4", art_description: "Fourth in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "No. 5", art_description: "Fifth in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "No. 6", art_description: "Sixth in series", available: true, styles: [abstract], artmedia: [painting, canvass], user_id: user.id)
steve.artworks.create(art_title: "Droplet", art_description: "Mosaic droplet", available: true, styles: [abstract, geometric], artmedia: [photography], user_id: user.id)